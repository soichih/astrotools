...
var $astro_tools = {
    ...
    parseRA: function(val) {  
        ...
        if( ! Numberish(val.charAt(i))){ times = 15.0 * 3600; break; }
        else { times = 3600; }
        }
    ...
    ra_d2hms: function(val_in) {
        val = parseFloat(val_in);
        var hh = this.val / 15.0 + (0.5 / 3600);
        var h = Math.floor(hh);
        hh = hh - h;
        hh = hh * 60;
        var m = Math.floor(hh);
    ...
    transform: function ( radec, matrix ) {
